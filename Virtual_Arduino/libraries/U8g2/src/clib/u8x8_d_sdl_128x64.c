...
static void u8g_sdl_init(int width, int height)
{
  ...
  u8g_sdl_window = SDL_CreateWindow("U8g2", 
...
static const u8x8_display_info_t u8x8_sdl_128x32_info =
{
  /* chip_enable_level = */ 0,
  /* chip_disable_level = */ 1,
...
uint8_t u8x8_d_sdl_128x32(u8x8_t *u8g2, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  uint8_t x, y, c;
  uint8_t *ptr;
  switch(msg)
  {
    case U8X8_MSG_DISPLAY_SETUP_MEMORY:
      u8x8_d_helper_display_setup_memory(u8g2, &u8x8_sdl_128x32_info);
      u8g_sdl_init(128, 32);
      break;
    case U8X8_MSG_DISPLAY_INIT:
      u8x8_d_helper_display_init(u8g2);
...
void u8x8_Setup_SDL_128x32(u8x8_t *u8x8)
{
  /* setup defaults */
  u8x8_SetupDefaults(u8x8);
  
  /* setup specific callbacks */
  u8x8->display_cb = u8x8_d_sdl_128x32;
...
void u8g2_SetupBuffer_SDL_128x32(u8g2_t *u8g2, const u8g2_cb_t *u8g2_cb)
{
  
  static uint8_t buf[128*4];
  
  u8x8_Setup_SDL_128x32(u8g2_GetU8x8(u8g2));
  u8g2_SetupBuffer(u8g2, buf, 8, u8g2_ll_hvline_vertical_top_lsb, u8g2_cb);
}
